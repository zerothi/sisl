...
__all__ = ['_diag_k_R_nc_csr_c64', '_diag_k_R_nc_csr_c128',
           '_diag_k_R_nc_array_c64', '_diag_k_R_nc_array_c128'] 
...
def _diag_k_R_nc_csr_c64(np.ndarray[np.int32_t, ndim=1, mode='c'] PTR,
...
@cython.initializedcheck(False)
@cython.cdivision(True)
def _diag_k_R_nc_csr_c128(np.ndarray[np.int32_t, ndim=1, mode='c'] PTR,
                          np.ndarray[np.int32_t, ndim=1, mode='c'] NCOL,
                          np.ndarray[np.int32_t, ndim=1, mode='c'] COL,
...
@cython.initializedcheck(False)
@cython.cdivision(True)
def _diag_k_R_nc_array_c64(np.ndarray[np.int32_t, ndim=1, mode='c'] PTR,
                           np.ndarray[np.int32_t, ndim=1, mode='c'] NCOL,
                           np.ndarray[np.int32_t, ndim=1, mode='c'] COL,
                           numeric_complex[:, ::1] D, const int idx, np.ndarray[np.complex64_t, ndim=1, mode='c'] PHASES):
...
@cython.initializedcheck(False)
@cython.cdivision(True)
def _diag_k_R_nc_array_c128(np.ndarray[np.int32_t, ndim=1, mode='c'] PTR,
                            np.ndarray[np.int32_t, ndim=1, mode='c'] NCOL,
                            np.ndarray[np.int32_t, ndim=1, mode='c'] COL,
                            numeric_complex[:, ::1] D, const int idx, np.ndarray[np.complex128_t, ndim=1, mode='c'] PHASES):
