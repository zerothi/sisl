...
__all__ = ['_k_R_nc_csr_c64', '_k_R_nc_csr_c128',
           '_k_R_nc_array_c64', '_k_R_nc_array_c128'] 
...
def _k_R_nc_csr_c64(np.ndarray[np.int32_t, ndim=1, mode='c'] PTR,
                    np.ndarray[np.int32_t, ndim=1, mode='c'] NCOL,
                    np.ndarray[np.int32_t, ndim=1, mode='c'] COL,
                    numeric_complex[:, ::1] D, np.ndarray[np.complex64_t, ndim=1, mode='c'] PHASES):
...
@cython.initializedcheck(False)
@cython.cdivision(True)
def _k_R_nc_csr_c128(np.ndarray[np.int32_t, ndim=1, mode='c'] PTR,
                     np.ndarray[np.int32_t, ndim=1, mode='c'] NCOL,
                     np.ndarray[np.int32_t, ndim=1, mode='c'] COL,
                     numeric_complex[:, ::1] D, np.ndarray[np.complex128_t, ndim=1, mode='c'] PHASES):
...
@cython.initializedcheck(False)
@cython.cdivision(True)
def _k_R_nc_array_c64(np.ndarray[np.int32_t, ndim=1, mode='c'] PTR,
                      np.ndarray[np.int32_t, ndim=1, mode='c'] NCOL,
                      np.ndarray[np.int32_t, ndim=1, mode='c'] COL,
                      numeric_complex[:, ::1] D, np.ndarray[np.complex64_t, ndim=1, mode='c'] PHASES):
...
@cython.initializedcheck(False)
@cython.cdivision(True)
def _k_R_nc_array_c128(np.ndarray[np.int32_t, ndim=1, mode='c'] PTR,
                       np.ndarray[np.int32_t, ndim=1, mode='c'] NCOL,
                       np.ndarray[np.int32_t, ndim=1, mode='c'] COL,
                       numeric_complex[:, ::1] D, np.ndarray[np.complex128_t, ndim=1, mode='c'] PHASES):
