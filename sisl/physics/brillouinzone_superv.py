...
class Supervisable:
    ...
    def __getattribute__(self, attr):
        ...
        if callable(val) and attr[0] != "_":
            return SupervisedMethod(val, real_getattr(self, "__supervise__")(val))
        else:
            return val
...
class BrillouinZone:
    ...
    def asaverage(self):
        ...
        # Set instance __call__
        setattr(self.parent, '__supervise__', types.MethodType(_call, self.parent))
