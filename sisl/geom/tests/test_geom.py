...
def test_fcc_slab():
    for o in [True, False]:
        ...
        g = fcc_slab(4.08, 79, '100', size=(3, 4, 5), orthogonal=o)
        g = fcc_slab(4.08, 79, '110', size=(3, 4, 5), vacuum=10, orthogonal=o)
        g = fcc_slab(4.08, 79, '111', size=(3, 4, 5), start=1, orthogonal=o)
...
def test_bcc_slab():
    for o in [True, False]:
        ...
        g = bcc_slab(4.08, 79, '100', size=(3, 4, 5), orthogonal=o)
        g = bcc_slab(4.08, 79, '110', size=(3, 4, 5), vacuum=10, orthogonal=o)
        g = bcc_slab(4.08, 79, '111', size=(3, 4, 5), start=1, orthogonal=o)
...
def test_rocksalt_slab():
    ...
    g = rocksalt_slab(5.64, ['Na', 'Cl'], 100, size=(3, 4, 5))
    gs = rocksalt_slab(5.64, ['Na', 'Cl'], 100, size=(3, 4, 5), sort=False)
