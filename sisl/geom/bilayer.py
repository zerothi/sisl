...
def bilayer(bond=1.42, bottom_atoms=None, top_atoms=None, stacking='AB',
    ...
    This routine follows the prescription of twisted bilayer graphene found in [Trambly2010]_.
    ...
    References
    ----------
    .. [Trambly2010] :doi:`G. Trambly de Laissardiere, D. Mayou, L. Magaud, "Localization of Dirac Electrons in Rotated Graphene Bilayers", Nano Letters 10, 804-808 (2010) <10.1021/nl902948m>`
    """
