...
def phase3_csr(const ints_st[::1] ptr,
...
def phase3_array(const ints_st[::1] ptr,
                 const ints_st[::1] ncol,
                 const ints_st[::1] col,
                 numerics_st[:, ::1] D,
                 const ints_st idx,
...
def phase3_csr_nc(const ints_st[::1] ptr,
                  const ints_st[::1] ncol,
                  const ints_st[::1] col,
                  numerics_st[:, ::1] D,
...
def phase3_array_nc(const ints_st[::1] ptr,
                    const ints_st[::1] ncol,
                    const ints_st[::1] col,
                    numerics_st[:, ::1] D,
                    const complexs_st[:, ::1] phases,
...
def phase3_csr_so(const ints_st[::1] ptr,
                  const ints_st[::1] ncol,
                  const ints_st[::1] col,
                  numerics_st[:, ::1] D,
                  const complexs_st[:, ::1] phases,
...
def phase3_array_so(const ints_st[::1] ptr,
                    const ints_st[::1] ncol,
                    const ints_st[::1] col,
                    numerics_st[:, ::1] D,
                    const complexs_st[:, ::1] phases,
...
def phase3_csr_nambu(const ints_st[::1] ptr,
                     const ints_st[::1] ncol,
                     const ints_st[::1] col,
                     numerics_st[:, ::1] D,
                     const complexs_st[:, ::1] phases,
...
def phase3_array_nambu(const ints_st[::1] ptr,
                       const ints_st[::1] ncol,
                       const ints_st[::1] col,
                       numerics_st[:, ::1] D,
                       const complexs_st[:, ::1] phases,
