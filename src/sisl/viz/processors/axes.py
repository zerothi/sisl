...
def sanitize_axes(val: Union[str, Sequence[Union[str, int, np.ndarray]]]) -> List[Union[str, int, np.ndarray]]:
...
def axes_cross_product(v1: Axis, v2: Axis, cell: Optional[Union[npt.ArrayLike, Lattice]] = None):
