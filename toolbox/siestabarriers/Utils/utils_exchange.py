...
def pre_prepare_sisl (frac_or_cart_or_index,Initial_Geom,InitialAtomPosition,FinalAtomPosition,rtol,atol):
...
def pre_prepare_ase_after_relax_AA(initial_XV,final_XV,Ghost):
    """
    """
    import sisl
...
def pre_prepare_ase_after_relax_A(initial_XV,final_XV):
    """
    """
    import sisl
    trace_atom_A_initial = sisl.Geometry(initial_XV.xyz[-2],
...
def pre_prepare_ase_after_relax_B(initial_XV,final_XV):
    """
    """
    import sisl
    trace_atom_B_initial = sisl.Geometry(initial_XV.xyz[-1],
    ...
    initial_XV = initial_XV.remove([-2])
    final_XV = final_XV.remove([-2])
