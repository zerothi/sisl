...
class GULPSile(Sile):
    ...
    def read_sc(self,key=None):
        ...
        if not f:
            raise ValueError(('GULPSile tries to lookup the SuperCell vectors '
    ...
    def read_geom(self,key=None):
        ...
        for sc_geom in range(2):
            ...
            if not f and ki == 0:
                ...
                raise ValueError(('GULPSile tries to lookup the Geometry coordinates '
                ...
                raise ValueError(('GULPSile tries to lookup the SuperCell or Geometry.\n'
