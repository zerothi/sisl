...
class Quaternion(object):
    ...
    def rotate(self,v):
        ...
        # First "flatten"
        v.shape = (-1,3)
        f = np.empty([v.shape[0],4],v.dtype)
    ...
    def __imul__(a,b):
        ...
        if isinstance(b,Quaternion):
            v1 = np.copy(a._v)
            v2 = b._v
            a._v[0] = v1[0]*v2[0] - v1[1]*v2[1] - v1[2]*v2[2] - v1[3]*v2[3]
            a._v[1] = v1[0]*v2[1] + v1[1]*v2[0] + v1[2]*v2[3] - v1[3]*v2[2]
            a._v[2] = v1[0]*v2[2] - v1[1]*v2[3] + v1[2]*v2[0] + v1[3]*v2[1]
            a._v[3] = v1[0]*v2[3] + v1[1]*v2[2] - v1[2]*v2[1] + v1[3]*v2[0]
        else:
            a._v *= b
        return a
